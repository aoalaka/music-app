                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        public void onCompletion(MediaPlayer mp) {
                            ...
                            Song songPosition = songs.get(position);
                            TextView textView = (TextView) findViewById(songPosition.getTextViewId());
                            ...
                            String songTitle = songPosition.getSongTitle().toUpperCase();
                            Toast.makeText(SongsActivity.this, "The song " + songTitle + " is finished", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
